...
date: 2024-11-22
tags: ["Graphs", "Social Networks","Optimization","Agent-based models","Econo-physics", "Published Papers"]
...
summary: "This paper offers a novel theoretical framework at the interface of physics and economics to understand and generate social networks using a dot-product latent space." 
cover:
    image: "opt.png"
...
<div style="padding: 15px; border: 1px solid var(--tertiary); border-radius: 8px; background-color: var(--code-bg); margin-bottom: 20px;">
    🎉 <b>Update:</b> This paper was published in <i>Social Network Analysis and Mining</i> on March 14, 2026. 
    <a href="https://link.springer.com/article/10.1007/s13278-026-01582-8">Read the final version here (Gold Open Access).</a>
</div>
...
```BibTeX
@article{labarthe2026generating,
  title={Generating social networks with static and dynamic utility-maximization approaches},
  author={Labarthe, Aldric and Kerzreho, Yann},
